...
```{r race-census-tract}
# write function
map_race <- function(df, variable, race, col) {
  df %>%
  ...
  ggplot(aes(fill = col)) +
    ...
    theme_void() +
    scale_fill_discret +
    labs(title = paste0("NYC % ", race, " by Census Tract 2020", sep = ""),
         caption = "Data source: ACS 5-yr 2016 - 2020",
         fill = "Percent")
}

map_race(nyc_race_2020_dc, "variable", "Black", "percent")
...
Importing Census Data into R through the **tidycensus** package gives us the ability to work with tidyverse-ready data. Furthermore, the ability to simultaneously import geometry features, makes visualizing Census Data a breeze.
